...
RSpec.describe SpreeCmCommissioner::PricingRules::ExtraAdults, type: :model do
  ...
  describe 'validations' do
    it 'invalid when min_extra_adults or max_extra_adults are not present' do
      subject.preferred_min_extra_adults = nil
      subject.preferred_max_extra_adults = nil

      subject.validate

      expect(subject.errors[:min_extra_adults]).to include('invalid_min_extra_adults')
      expect(subject.errors[:max_extra_adults]).to include('invalid_max_extra_adults')
    end

    it 'invalid when min_extra_adults or max_extra_adults <= 0' do
    ...
    it 'invalid when min_extra_adults is greater than max_extra_adults' do
    ...
    it 'valid when when min_extra_adults and max_extra_adults are present' do
