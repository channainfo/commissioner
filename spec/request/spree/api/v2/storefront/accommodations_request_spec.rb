...
RSpec.describe Spree::Api::V2::Storefront::AccommodationsController, type: :request do
  ...
  describe 'GET /api/v2/storefront/novel/accommodations' do
    ...
    context 'with valid parameters' do
      before do
        get '/api/v2/storefront/novel/accommodations', params: valid_params
      end
    ...
    context 'with missing required parameters' do
      before do
        get '/api/v2/storefront/novel/accommodations', params: { state_id: state.id }
      end
    ...
    context 'with sorting by min_price' do
      ...
      before do
        ...
        get '/api/v2/storefront/novel/accommodations', params: valid_params.merge(sort: 'min_price')
      end
    ...
    context 'with no matching vendors' do
      ...
      before do
        get '/api/v2/storefront/novel/accommodations', params: params_with_different_state
      end
  ...
  describe 'GET /api/v2/storefront/novel/accommodations/:id' do
    ...
    context 'with a valid ID' do
      before do
        get "/api/v2/storefront/novel/accommodations/#{vendor.id}", params: valid_params
      end
    ...
    context 'with an invalid ID' do
      ...
      before do
        get "/api/v2/storefront/novel/accommodations/#{invalid_vendor.id}", params: valid_params
      end
