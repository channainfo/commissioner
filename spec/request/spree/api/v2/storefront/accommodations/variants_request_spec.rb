...
RSpec.describe Spree::Api::V2::Storefront::Accommodations::VariantsController, type: :request do
  ...
  describe 'GET /api/v2/storefront/accommodations/:accommodation_id/variants' do
    let(:valid_params) do
      {
    ...
    context 'with valid parameters' do
      before do
        get "/api/v2/storefront/accommodations/#{vendor.id}/variants", params: valid_params
      end
    ...
    context 'with missing required parameters' do
      before do
        get "/api/v2/storefront/accommodations/#{vendor.id}/variants", params: { accommodation_id: vendor.id }
      end
  ...
  describe 'GET /api/v2/storefront/accommodations/:accommodation_id/variants/:id' do
    let(:valid_params) do
      {
        from_date: from_date.to_s,
        to_date: to_date.to_s,
    ...
    context 'with a valid ID' do
      before do
        get "/api/v2/storefront/accommodations/#{vendor.id}/variants/#{variant.id}", params: valid_params
      end
    ...
    context 'with an invalid ID' do
      ...
      before do
        ...
        get "/api/v2/storefront/accommodations/#{vendor.id}/variants/#{invalid_variant.id}", params: valid_params
      end
