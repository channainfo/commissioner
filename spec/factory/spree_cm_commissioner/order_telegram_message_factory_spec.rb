...
RSpec.describe SpreeCmCommissioner::OrderTelegramMessageFactory do
  ...
  describe '#body' do
    ...
    context 'for specific vendor' do
      ...
      let(:line_item1) { build(:line_item, variant: variant1, from_date: date('2023-01-11'), to_date: date('2023-01-12')) }
      let(:line_item2) { build(:line_item, variant: variant2, from_date: date('2023-01-11'), to_date: date('2023-01-12')) }
