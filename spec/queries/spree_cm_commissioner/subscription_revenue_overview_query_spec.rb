...
RSpec.describe SpreeCmCommissioner::SubscriptionRevenueOverviewQuery do
  ...
  describe '#reports' do
    before do
      ...
      create(:cm_subscription, start_date: '2024-05-16'.to_date, customer: customer2, price: 25.0, due_date: 5)
      create(:cm_subscription, start_date: '2024-05-17'.to_date, customer: customer3, price: 32.0, due_date: 5)
    ...
    it 'only return totals in January' do
      ...
      # # only for may
      query = described_class.new(from_date: '2024-06-15', to_date: '2024-07-14', vendor_id: vendor.id)
