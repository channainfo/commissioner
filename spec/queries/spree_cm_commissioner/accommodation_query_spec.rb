...
RSpec.describe SpreeCmCommissioner::AccommodationQuery do
  ...
  let!(:phnom_penh_hotel) { create(:cm_vendor_with_product, name: 'Phnom Penh Hotel',       default_state_id: phnom_penh.id, total_inventory: 20, primary_product_type: :accommodation) }
  ...
  let!(:sokha_hotel)      { create(:cm_vendor_with_product, name: 'Sokha Hotel', state: :pending, default_state_id: phnom_penh.id, total_inventory: 20, primary_product_type: :accommodation) }
  let!(:angkor_hotel)     { create(:cm_vendor_with_product, name: 'Angkor Hotel',           default_state_id: siem_reap.id,  total_inventory: 20, primary_product_type: :accommodation) }
  let!(:siemreap_hotel)   { create(:cm_vendor_with_product, name: 'Siem Reap Hotel',        default_state_id: siem_reap.id,  total_inventory: 20, primary_product_type: :accommodation) }
  let!(:siemreap_hotel1)  { create(:cm_vendor_with_product, name: 'Siem Reap Hotel1',        default_state_id: siem_reap.id,  total_inventory: 20, primary_product_type: :accommodation) }
  let!(:run_with_sai)     { create(:cm_vendor_with_product, name: 'Run with Sai',        default_state_id: siem_reap.id,  total_inventory: 20) }
