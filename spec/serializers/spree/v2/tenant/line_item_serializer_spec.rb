...
RSpec.describe Spree::V2::Tenant::LineItemSerializer, type: :serializer do
  describe '#serializable_hash' do
    let(:product) { Spree::Product.create(name: 'ProductA', price: 10.00, product_type: :accommodation) }
