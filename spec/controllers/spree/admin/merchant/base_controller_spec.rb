...
RSpec.describe Spree::Admin::Merchant::BaseController, type: :controller do
  context 'role authorization' do
    ...
    it 'unauthorize index when user does not have permission' do
      ...
      expect(response).to redirect_to 'http://test.host/admin/forbidden?vendor_id=active-vendor'
    end
  end
end