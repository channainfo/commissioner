  ...
  module RedisStock
    class InventoryUpdater
      ...
      def cached_inventory_items
        @cached_inventory_items ||= SpreeCmCommissioner::RedisStock::LineItemsCachedInventoryItemsBuilder.new(@line_item_ids).call.values.flatten
      end
      ...
      def extract_inventory_data
        ...
        cached_inventory_items.map do |cached_inventory_item|
