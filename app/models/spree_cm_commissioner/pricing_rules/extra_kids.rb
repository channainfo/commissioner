  ...
  module PricingRules
    class ExtraKids < PricingRule
      ...
      def validate_extra_kids
        errors.add(:min_extra_kids, 'invalid_min_extra_kids') if preferred_min_extra_kids <= 0
        errors.add(:max_extra_kids, 'invalid_max_extra_kids') if preferred_max_extra_kids <= 0
